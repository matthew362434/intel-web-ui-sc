...
import { CPGroupItem } from '../cp-group-item';
...
export const CPGroupsList = ({ groups, isPadding, updateParameter, isHPO }: CPGroupsListProps): JSX.Element => {
    const isExpandable = groups.length > 1;
    return (
        <View paddingStart={isPadding ? 'size-250' : ''} paddingEnd={'size-250'}>
            <AnimatePresence>
