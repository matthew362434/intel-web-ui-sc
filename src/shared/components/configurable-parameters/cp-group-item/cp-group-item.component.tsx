...
import { ChevronUpLight, ChevronRightSmallLight } from '../../../../assets/icons';
...
export const CPGroupItem = ({ group, isExpandable, updateParameter, isHPO }: CPGroupItemProps): JSX.Element => {
    ...
    return (
        <View marginBottom={'size-125'} marginEnd={'size-150'}>
            ...
            {isExpandable ? (
                isExpanded ? (
                    <CPParamsList isHPO={isHPO} parameters={parameters} updateParameter={updateParameter} />
                ) : (
                    <></>
                )
            ) : (
