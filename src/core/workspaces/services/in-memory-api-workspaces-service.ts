...
export const createInMemoryApiWorkspacesService = (): CreateApiWorkspacesService => {
    ...
    const getProductVersion = async () => Promise.resolve<VersionEntity>({ productVersion: 'v1' });
