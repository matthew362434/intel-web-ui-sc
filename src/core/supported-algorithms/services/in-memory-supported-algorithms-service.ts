...
export const createInMemorySupportedAlgorithms = (): CreateApiSupportedAlgorithmsService => {
    const getSupportedAlgorithms = (): Promise<SupportedAlgorithm[]> => {
        return Promise.resolve(mockedSupportedAlgorithms);
    };
