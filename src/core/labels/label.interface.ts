...
export interface NewLabel extends LabelCommon {
...
export type EditedLabel = Label | NewLabel | DeletedLabel;
...
export interface AddLabelInterface {
    name: string;
    color: string;
    hotkey?: string;
}
...
export enum LABEL_BEHAVIOUR {
    ...
    // When applying an exlusive label to a media item or to an annotation (in case
