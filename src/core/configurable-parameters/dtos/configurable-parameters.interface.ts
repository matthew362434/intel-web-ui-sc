...
export interface ConfigurableParametersGroupBasicParamsDTO extends ConfigurableParametersBasicDTO {
    warning: string | null;
    editable: boolean;
    auto_hpo_state: 'not_possible' | 'possible' | 'optimized' | 'overridden';
}
...
export interface EntityIdentifierGenericModelDTO {
    workspace_id: string;
...
export interface ConfigurableParametersGlobalDTO extends Omit<ConfigurableParametersBasicDTO, 'name'> {
    id: string;
