...
import { roiFromImage } from '../../../core/annotations';
import { allowPanning } from './utils';

type CanvasProps = SVGProps<SVGSVGElement> & { image: HTMLImageElement } & { canvasRef?: RefObject<SVGRectElement> };
...
export const SvgToolCanvas: FC<CanvasProps> = ({
    image,
    children,
    canvasRef,
    onPointerDown,
