...
import { getMockedAnnotation, getMockedLabel, labels as mockLabels } from '../../../../test-utils/mocked-items-factory';
import { useAnnotationScene, AnnotationSceneProvider } from './annotation-scene-provider.component';
...
describe('Annotation scene provider', (): void => {
    ...
    describe('labelling annotations', () => {
        describe('Adding labels', () => {
            ...
            it('adds labels using label resolver', (): void => {
                ...
                fireEvent.click(screen.getByRole('button'));
                expect(screen.getByText(`${mockAnnotations[0].id} - card, 4, red, ♥`)).toBeInTheDocument();
    ...
    it('Requires the AnnotationSceneProvider', () => {
