...
describe('Reconfigure parameters of the model', () => {
    ...
    const renderReconfigureModels = async (): Promise<void> => {
        await render(<ReconfigureModels />);
    ...
    it('should the first task`s component tab be selected and unfolded by default', async () => {
        ...
        expect(firstTab).toHaveClass('tabItemSelected', { exact: false });
    ...
    it('should the content change based on the selected component of given task', async () => {
        ...
        expect(firstComponent).toHaveClass('tabItemSelected', { exact: false });
        expect(secondComponent).not.toHaveClass('tabItemSelected', { exact: false });
        ...
        expect(secondComponent).toHaveClass('tabItemSelected', { exact: false });
        expect(firstComponent).not.toHaveClass('tabItemSelected', { exact: false });
