...
} from '../../../../../core/statistics/dtos/model-statistics.interface';

export interface TrainingModelStatisticsConfusionMatrixData
...
export type TrainingModelStatisticsData =
    | ModelStatisticsTextDataDTO
    | ModelStatisticsBarDataDTO
