...
export const ProjectAnnotationsVideos = ({
    ...
    return (
        <ProjectCardContent title='Annotated videos / frames' gridArea={gridArea}>
            <Flex direction={'column'} justifyContent={'center'} height={'100%'} marginStart={'size-130'}>
                <Flex alignItems={'center'} gap={'size-200'}>
                    ...
                    <Text UNSAFE_className={classes.projectAnnotationsVideosText} id='annotated-videos-count-id'>
                        <CountUp end={annotatedVideos} />
                    </Text>
                </Flex>
                <Flex alignItems={'center'} gap={'size-200'}>
                    <Text id='annotated-frames-id'>Frames:</Text>
                    <Text UNSAFE_className={classes.projectAnnotationsVideosText} id='annotated-frame-count-id'>
